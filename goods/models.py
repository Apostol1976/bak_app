...
class Products(models.Model):
    ...
    insdepth=models.DecimalField(default=0, max_digits=2, decimal_places=0, verbose_name='Глубина профиля')
    ...
    soundinstall=models.DecimalField(default=0, max_digits=2, decimal_places=0, verbose_name='Коэффициент звукоизоляции')
    thermaltransm=models.DecimalField(default=0, max_digits=4, decimal_places=2, verbose_name='Коэффициент теплоотдачи')
